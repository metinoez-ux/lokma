...
if target in text:
    ...
    print("TARGET NOT FOUND. FALLING BACK TO ALTERNATE REPLACEMENT METHOD.")
    # Alternate fallback search due to carriage returns / indent variance
    target2 = "})} \n  </div>\n  )}"
    # I'll just use regex logic if needed
