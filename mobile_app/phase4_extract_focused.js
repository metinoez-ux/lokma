...
console.log(`Found ${uniqueStrings.length} unique strings in Phase 4 (Cart/Profile/Auth).`);
fs.writeFileSync('phase4_strings_focused.json', JSON.stringify(uniqueStrings, null, 2));
