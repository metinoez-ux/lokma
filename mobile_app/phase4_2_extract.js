...
const targetDirs = [
    path.join(__dirname, 'lib/screens/business'),
    path.join(__dirname, 'lib/screens/checkout'),
    path.join(__dirname, 'lib/screens/discovery'),
...
console.log(`Found ${uniqueStrings.length} unique strings in Phase 4.2.`);
fs.writeFileSync('phase4_2_strings.json', JSON.stringify(uniqueStrings, null, 2));
