...
const phase2Trans = JSON.parse(fs.readFileSync('phase2_translations_merged.json', 'utf8'));
...
for (const lang of languages) {
    ...
    if (fs.existsSync(filePath)) {
        ...
        const newTranslations = phase2Trans[lang];
        if (newTranslations) {
        ...
        console.log(`Updated Phase 2 in ${lang}.json`);
    } else {
