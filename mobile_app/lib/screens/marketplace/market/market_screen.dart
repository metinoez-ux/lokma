...
class _MarketScreenState extends ConsumerState<MarketScreen> {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Image.asset('assets/images/tuna_logo_pill.png', height: 40,
  ...
  Widget _buildMarketCard(String id, Map<String, dynamic> data) {
    ...
    return WalletBusinessCard(
      ...
      unavailableReason: availability.reason ?? tr('marketplace.currently_closed'),
      ...
      distance: distanceText.isNotEmpty ? double.tryParse(distanceText.split(' ')[0]) ?? 0.0 : 0.0,
      onTap: () {
        HapticFeedback.lightImpact();
        if (!isAvailable) {
