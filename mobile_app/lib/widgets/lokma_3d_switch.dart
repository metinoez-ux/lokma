...
/// Matches the premium LOKMA design language with recessed depth effect
class Lokma3DSwitch extends StatelessWidget {
  final bool value;
  ...
  const Lokma3DSwitch({
    ...
    this.activeColor = const Color(0xFFEA184A),
    this.width = 50,
    this.height = 30,
  });
