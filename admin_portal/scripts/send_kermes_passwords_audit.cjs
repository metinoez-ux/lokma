...
const reportPath = '/Users/metinoz/.gemini/antigravity/brain/3a2cef24-76fe-4d30-98aa-e83b4c030e4d/audit_report_kermes_passwords.md';
const report = fs.readFileSync(reportPath, 'utf8');

resend.emails.send({
  from: 'LOKMA System <info@lokma.shop>',
  to: 'metin.oez@gmail.com',
  subject: 'LOKMA Kermes Staff/Driver Password & Credentials Audit - 29 Mart 2026',
