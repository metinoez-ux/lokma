...
const targetFiles = [
    'src/app/[locale]/admin/ai-menu/page.tsx',
    'src/app/[locale]/admin/staff/page.tsx',
    'src/app/[locale]/admin/staff-dashboard/page.tsx',
    'src/app/[locale]/admin/staff-shifts/page.tsx',
...
targetFiles.forEach(filePath => {
    ...
    try {
        ...
        if (fileStrings.size > 0) {
            let namespace = '';
            if (filePath.includes('ai-menu')) namespace = 'AdminAIMenu';
            else if (filePath.includes('staff')) namespace = 'AdminStaff';
            else if (filePath.includes('products')) namespace = 'AdminProducts';
            else if (filePath.includes('invoices')) namespace = 'AdminInvoices';
            else if (filePath.includes('business')) namespace = 'AdminBusiness';
...
fs.writeFileSync('phase1_extract.json', JSON.stringify(extractMap, null, 2));
console.log('Extraction complete. Saved to phase1_extract.json');
