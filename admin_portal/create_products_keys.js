...
const strings = JSON.parse(fs.readFileSync('products_strings.json', 'utf8'));
const map = {};
...
fs.writeFileSync('products_map.json', JSON.stringify(map, null, 2));
fs.writeFileSync('products_tr.json', JSON.stringify(trJson, null, 2));
