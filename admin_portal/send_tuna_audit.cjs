...
const report = fs.readFileSync('/Users/metinoz/.gemini/antigravity/brain/99d91ac9-3c79-4643-9e8a-a51131b1a008/tuna_kermes_audit_2026_03_28.md', 'utf8');

resend.emails.send({
  from: 'LOKMA System <info@lokma.shop>',
  to: 'metin.oez@gmail.com',
  subject: 'LOKMA Kermes Tuna Badge & Admin Audit - 28 Mart 2026',
