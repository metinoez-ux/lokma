...
export default function ReservationCapacityConfig({
 ...
 className="w-full bg-gray-700 text-white px-3 py-2.5 rounded-lg border border-gray-600 focus:border-amber-500 focus:outline-none font-medium"
 />
 <span className="text-muted-foreground/80 text-xs whitespace-nowrap">dk</span>
 </div>
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_temizlik_suresi_aciklama")}</p>
 </div>
 <div>
 <label className="text-gray-400 text-xs block mb-1">
 {t("rc_buffer_suresi")}
 ...
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_buffer_suresi_aciklama")}</p>
 </div>
 <div>
 <label className="text-gray-400 text-xs block mb-1">
 {t("rc_min_onceden")}
 ...
 className="w-full bg-gray-700 text-white px-3 py-2.5 rounded-lg border border-gray-600 focus:border-amber-500 focus:outline-none font-medium"
 />
 <span className="text-muted-foreground/80 text-xs whitespace-nowrap">{t("rc_saat")}</span>
 </div>
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_min_onceden_aciklama")}</p>
 </div>
 <div>
 <label className="text-gray-400 text-xs block mb-1">
 {t("rc_maks_gunluk")}
 ...
 />
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_maks_gunluk_aciklama")}</p>
 </div>
 </div>
 ...
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_kabul_saatleri_aciklama")}</p>
 </div>
 ...
 />
 <span className="text-muted-foreground/80 text-xs">{t("rc_kisi")}</span>
 </div>
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_otomatik_onay_aciklama")}</p>
 </div>
 ...
 <div className={`w-10 h-6 rounded-full p-1 transition-colors ${config.requirePreorderPayment ? 'bg-background/30' : 'bg-gray-900 pointer-events-none'}`}>
 <div className={`w-4 h-4 rounded-full bg-background transition-transform ${config.requirePreorderPayment ? 'translate-x-4' : 'translate-x-0'}`} />
 </div>
 </button>
 ...
 <p className="text-muted-foreground text-[10px] mt-1">{t("rc_haftalik_musaitlik_aciklama")}</p>
 </div>
 </div>
 )}
 </div>
 ...
 <p className="text-muted-foreground/80 text-sm">{t("rc_blok_yok")}</p>
 </div>
 ) : (
