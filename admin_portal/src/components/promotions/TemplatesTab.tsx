...
export default function TemplatesTab({ templates, setTemplates, loaded, setLoaded }: Props) {
 ...
 <span className={`w-4 h-4 rounded border-2 flex items-center justify-center text-xs ${isSelected ? 'border-white bg-background/20' : 'border-gray-500'}`}>
 {isSelected && '✓'}
 </span>
 {p.label}
 </button>
 ...
 <p className="text-muted-foreground/80 text-xs mt-1.5">Unternehmen mit den ausgewählten Plänen können diese Vorlage sehen</p>
 </div>
 <div>
