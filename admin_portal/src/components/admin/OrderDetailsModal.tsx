...
export default function OrderDetailsModal({
 ...
 <button
 onClick={onClose}
 className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-muted/50 dark:hover:bg-gray-700"
 >
 ✕
 </button>
 </div>
 ...
 {/* Address */}
 {order.address && (
 <div className="flex items-center justify-between bg-muted dark:bg-gray-700/30 rounded-lg p-3">
 ...
 : 'bg-card text-muted-foreground border-border dark:border-gray-600'
 }`}>
 ...
 <div className="bg-muted dark:bg-card/80 border border-border dark:border-gray-600 rounded-lg p-3 space-y-1 text-sm text-foreground/80 dark:text-gray-200">
 {Object.values(
 ...
 <span className={`flex-1 font-medium ${isChecked ? 'text-green-600 dark:text-green-300 line-through opacity-70' : item.isFreeDrink ? 'text-emerald-700 dark:text-emerald-300' : 'text-foreground/90 dark:text-gray-200'}`}>
 ...
 <span className="line-through text-muted-foreground/80 text-[10px]">{formatCurrency(item.originalPrice || item.unitPrice || 0, order?.currency)}</span>
 <span>0,00 €</span>
 </div>
 ) : (
 ...
 <div key={pName} className="bg-muted/30 dark:bg-card border border-border/50 dark:border-gray-600 rounded-xl p-3 shadow-sm mb-3">
 <div className="flex items-center gap-2 mb-3">
 <span className="text-purple-800 dark:text-purple-400 text-sm">👤</span>
 <span className="text-foreground text-sm font-semibold border-b border-border dark:border-gray-600 pb-0.5 w-full">{pName}</span>
 </div>
 ...
 {rawStatus === 'confirmed' && (
 <div className="bg-muted dark:bg-gray-800 border border-border/50 dark:border-gray-700 rounded-xl p-3 flex items-center justify-center text-muted-foreground/80 dark:text-gray-400 font-bold shadow-inner">
 ✅ Onaylandı
 </div>
 )}
 {rawStatus === 'rejected' && (
 ...
 <div className="bg-muted dark:bg-gray-700/30 rounded-lg p-3 text-center text-muted-foreground text-sm mt-4">
 ...
 ? 'bg-muted dark:bg-gray-800 text-gray-400 dark:text-muted-foreground/80 cursor-not-allowed border border-border/50 dark:border-gray-700'
 : 'bg-background dark:bg-gray-700 text-foreground/80 dark:text-gray-200 hover:bg-muted/30 dark:hover:bg-gray-600 border border-border/50 dark:border-gray-600 shadow-sm'
 }`}
 >
 ...
 <summary className="px-4 py-2 text-sm text-muted-foreground font-medium cursor-pointer flex items-center justify-between hover:bg-muted dark:hover:bg-gray-700/50 transition-colors">
 ...
 ? 'bg-muted dark:bg-gray-800 text-gray-400 dark:text-muted-foreground cursor-not-allowed border border-border/50 dark:border-gray-700'
 : 'bg-background dark:bg-gray-700/50 text-foreground/80 dark:text-gray-200 hover:bg-muted/30 dark:hover:bg-gray-600 border border-border/50 dark:border-gray-600 shadow-sm'
 }`}
 >
 {t(value.labelKey)}
 </button>
 ...
 ? 'bg-muted dark:bg-gray-700 border border-border/50 dark:border-gray-600 text-muted-foreground dark:text-gray-300 hover:bg-muted/50 dark:hover:bg-gray-600'
 ...
 className="text-muted-foreground hover:text-foreground transition-colors p-1.5 rounded-full hover:bg-muted/50 dark:hover:bg-gray-700"
 >
 ✕
 </button>
 </div>
 ...
 className="bg-muted/50 dark:bg-gray-700/50 hover:bg-gray-300 dark:hover:bg-gray-600 border border-border dark:border-gray-600 text-foreground/90 dark:text-gray-200 px-3 py-2 rounded-lg text-sm transition-colors text-left"
 >
 ...
 className="w-full bg-background border border-border dark:border-gray-600 rounded-xl p-4 text-foreground placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none h-28"
 />
 ...
 className="flex-1 px-4 py-3 bg-muted/50 dark:bg-gray-700 text-foreground/90 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition font-medium"
 >
 ...
 <ul className="space-y-1.5 list-disc list-inside text-foreground/80 dark:text-gray-200 text-sm">
 {unavailableItems.map((item, idx) => (
 <li key={idx} className="flex justify-between items-center group">
 <span>
 <span className="text-yellow-800 dark:text-yellow-400 font-medium">{item.quantity}x</span> {item.name}
 </span>
 <span className="text-muted-foreground/80 text-xs font-medium">{formatCurrency(item.price, order.currency)}</span>
 </li>
 ))}
 </ul>
 </div>
 ...
 className="flex-1 px-4 py-3 bg-muted/50 dark:bg-gray-800 text-foreground/90 dark:text-gray-200 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-700 transition font-medium"
 >
 {t('cancelModal.cancel')}
 </button>
 <button
