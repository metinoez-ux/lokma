...
export default function CiftcidenPage() {
 ...
 <p className="text-muted-foreground /70 mb-6 leading-relaxed">{t('problemDesc')}</p>
 <div className="grid md:grid-cols-3 gap-6">
 {(['s1', 's2', 's3'] as const).map(k => (
 <div key={k} className="text-center p-4 bg-muted/30 dark:bg-background/5 rounded-xl">
 <div className="text-3xl font-black text-red-400 mb-2">{t(k)}</div>
 <p className="text-sm text-muted-foreground/80 /60">{t(`${k}d`)}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <p className="text-muted-foreground /70 mb-6 leading-relaxed">{t('solDesc')}</p>
 ...
 <p className="text-sm text-muted-foreground/80 /60">{t(`${f}d`)}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <div key={i} className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-xl p-4 text-center">
 ...
 <a href="https://apps.apple.com/app/lokma" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-background text-black px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">
 <span className="text-2xl"></span> App Store
 </a>
 <a href="https://play.google.com/store/apps/details?id=com.lokma.app" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-background text-black px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">
 ...
 <Link href="/partner/apply" className="inline-block bg-background text-green-600 px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">
 {t('farmerCta')}
 </Link>
 </div>
 </div>
