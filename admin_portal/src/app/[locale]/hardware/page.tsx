...
export default function HardwarePage() {
 ...
 <Link
 href="/contact"
 className="inline-flex items-center justify-center gap-2 bg-background/5 hover:bg-background/10 border border-white/20 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all backdrop-blur-sm"
 >
 ...
 <div key={i} className="bg-background/5 backdrop-blur-md border border-white/10 rounded-2xl p-4">
 ...
 {/* Flow diagram */}
 <div className="bg-background/[0.03] border border-white/10 rounded-3xl p-8 md:p-12">
 ...
 <div key={i} className="flex items-center gap-3 bg-background/[0.03] rounded-xl p-3 border border-white/5">
 ...
 <div key={i} className="flex items-start gap-4 bg-background/[0.03] rounded-xl p-4 border border-white/5 hover:border-purple-500/30 transition-colors">
 ...
 <div key={i} className="flex items-start gap-4 bg-background/[0.03] rounded-xl p-4 border border-white/5 hover:border-teal-500/30 transition-colors">
 ...
 <div key={i} className="bg-background/[0.03] border border-white/5 rounded-xl p-4 hover:border-emerald-500/30 transition-all group/item">
 ...
 <Link
 href="/contact"
 className="inline-flex items-center justify-center gap-2 bg-background/5 hover:bg-background/10 border border-white/20 text-white px-12 py-5 rounded-2xl font-bold text-xl transition-all"
 >
