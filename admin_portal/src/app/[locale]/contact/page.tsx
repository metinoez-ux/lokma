...
export default function ContactPage() {
 ...
 <div className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-2xl p-8">
 ...
 <p className="text-muted-foreground/80 /60">
 LOKMA GmbH<br />
 Musterstraße 123<br />
 10115 Berlin<br />
 Deutschland
 ...
 <p className="text-sm text-muted-foreground/80 /60">info@lokma.shop</p>
 </a>
 <a href="mailto:destek@lokma.shop" className="bg-background/5 border border-white/10 rounded-xl p-6 hover:border-[#ea184a]/50 transition-all text-center">
 ...
 <a href="mailto:partner@lokma.shop" className="bg-background/5 border border-white/10 rounded-xl p-6 hover:border-[#ea184a]/50 transition-all text-center">
 ...
 <p className="text-muted-foreground/80 /60 mb-6">{t('merchantDesc')}</p>
 <Link
 href="/partner/apply"
