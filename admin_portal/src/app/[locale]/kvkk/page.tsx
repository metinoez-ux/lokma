...
export default function KVKKPage() {
 ...
 <p className="text-muted-foreground/80 /60 mb-8">{titleTx.updated}</p>

 <div className="space-y-8 text-muted-foreground /80">
 {sections.main.map((section, i) => (
 <section key={i}>
 <h2 className="text-2xl font-bold text-foreground mb-4">{section.title[locale] || section.title.en}</h2>
 {section.content && (
