...
export default function NotificationsPage() {
 ...
 className="w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-foreground"
 maxLength={50}
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{title.length}/50</p>
 </div>
 ...
 rows={4}
 className="w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-foreground"
 maxLength={200}
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{body.length}/200</p>
 </div>
 ...
 <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-muted/30 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50">
 <input
 type="radio"
 name="audience"
 checked={sendToAll}
 ...
 />
 <div>
 <span className="font-medium text-foreground">Tüm Kullanıcılar</span>
 <p className="text-xs text-muted-foreground/80">Uygulamayı kullanan herkese gönder</p>
 </div>
 </label>
 ...
 <span className="font-medium text-foreground">Belirli Konu</span>
 <p className="text-xs text-muted-foreground/80">Sadece konuya abone olanlara gönder</p>
 </div>
 </label>
 </div>
 ...
 className="mt-3 w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 text-foreground"
 >
