...
function RegisterContent() {
 ...
 <h1 className="text-2xl font-bold text-foreground mb-2">Registrierung abgeschlossen!</h1>
 ...
 <h1 className="text-2xl font-bold text-foreground">Super Admin Registrierung</h1>
 ...
 <div>
 <label className="block text-sm font-medium text-foreground/80 dark:text-gray-300 mb-1">Passwort *</label>
 <input
 type="password"
 value={password}
 ...
 <div>
 <label className="block text-sm font-medium text-foreground/80 dark:text-gray-300 mb-1">Passwort wiederholen *</label>
 <input
 type="password"
 ...
 {/* Address */}
 <div className="border-t pt-6">
 <h3 className="font-semibold text-foreground mb-4">Adressdaten</h3>
 ...
 <div className="grid grid-cols-2 gap-4 mt-4">
 <div>
 <label className="block text-sm font-medium text-foreground/80 dark:text-gray-300 mb-1">PLZ</label>
 <input
 type="text"
 value={postalCode}
 ...
 <div className="grid grid-cols-2 gap-4 mt-4">
 <div>
 <label className="block text-sm font-medium text-foreground/80 dark:text-gray-300 mb-1">Bundesland</label>
 <select
 value={state}
