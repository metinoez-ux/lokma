...
export default function WiderrufsbelehrungPage() {
 ...
 <h2 className="text-2xl font-bold text-foreground mt-10 mb-4 border-b border-border/50 pb-2">Vorzeitiges Erlöschen des Widerrufsrechts</h2>
 <div className="bg-red-500/10 border border-red-500/20 p-5 rounded-xl mb-4">
 <p className="text-foreground font-medium">Bedeutende Ausnahme für Speisenlieferungen:</p>
 <p className="mt-2">
 ...
 <h2 className="text-2xl font-bold text-foreground mt-10 mb-4 border-b border-border/50 pb-2">Folgen des Widerrufs</h2>
 <p>
