...
export default function DineInTablePage() {
 ...
 <div className="absolute inset-0 bg-gradient-to-b from-[#ea184a]/10 via-[#120a0a] to-[#120a0a]" />
 <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#ea184a]/5 rounded-full blur-3xl animate-pulse" />
 </div>

 <div className="relative z-10 max-w-md w-full text-center space-y-8">
 {/* Logo */}
 <div className="flex justify-center">
 <div className="w-20 h-20 rounded-2xl bg-background/10 backdrop-blur-xl border border-white/20 flex items-center justify-center shadow-2xl">
 <Image
 src="/lokma_logo.png"
 alt="LOKMA"
 width={56}
 ...
 {loading ? (
 <div className="h-6 w-48 bg-background/10 rounded-lg animate-pulse" />
 ) : (
 <>
 {businessName && (
 <span className="text-lg font-semibold text-[#ea184a]">{businessName}</span>
 )}
 <span className="text-white/30">•</span>
 <span className="inline-flex items-center gap-1.5 bg-background/10 px-3 py-1 rounded-full text-sm font-medium">
 🍽️ Masa {tableNum}
 </span>
 </>
 )}
 ...
 <div className="w-28 h-28 rounded-3xl bg-gradient-to-br from-[#ea184a]/20 to-[#ea184a]/5 border border-[#ea184a]/30 flex items-center justify-center">
 <svg className="w-14 h-14 text-[#ea184a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
 </svg>
 </div>
 {/* Pulse ring */}
 <div className="absolute inset-0 rounded-3xl border-2 border-[#ea184a]/20 animate-ping" />
 </div>
 </div>
 ...
 className="flex items-center justify-center gap-3 w-full bg-background text-black py-4 rounded-2xl font-bold text-base hover:bg-background/90 transition-all shadow-xl"
 >
 ...
 className="flex items-center justify-center gap-3 w-full bg-background/10 border border-white/20 text-white py-4 rounded-2xl font-bold text-base hover:bg-background/20 transition-all"
 >
