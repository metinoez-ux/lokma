...
export default function ElLezzetleriPage() {
 ...
 <p className="text-xl text-muted-foreground/80 /60 max-w-2xl mx-auto leading-relaxed">{t('heroSub')}</p>
 </div>
 ...
 <p className="text-muted-foreground /70 mb-6 leading-relaxed">{t('whatDesc')}</p>
 <div className="grid md:grid-cols-3 gap-6">
 {(['c1', 'c2', 'c3'] as const).map(c => (
 <div key={c} className="text-center p-4 bg-muted/30 dark:bg-background/5 rounded-xl">
 <h3 className="font-bold mb-1">{t(c)}</h3>
 <p className="text-sm text-muted-foreground/80 /60">{t(`${c}d`)}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <p className="text-muted-foreground /70 mb-6 leading-relaxed">{t('trustDesc')}</p>
 ...
 {categories.map(cat => (
 <div key={cat.icon} className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-xl p-4 hover:bg-muted dark:hover:bg-background/10 transition-all cursor-pointer text-center">
 ...
 <p className="text-muted-foreground/80 /60 mb-8 max-w-xl mx-auto">{t('appDesc')}</p>
 <div className="flex flex-wrap items-center justify-center gap-4">
 <a href="https://apps.apple.com/app/lokma" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-background text-black px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">App Store</a>
 <a href="https://play.google.com/store/apps/details?id=com.lokma.app" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-background text-black px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">Google Play</a>
 </div>
 </div>
 ...
 <Link href="/partner/apply" className="inline-block bg-background text-amber-600 px-8 py-4 rounded-xl font-bold hover:bg-muted transition-all">
 {t('producerCta')}
 </Link>
 </div>
 </div>
