                ...
                <div className="max-w-[1000px] mx-auto">
                    ...
                    <div className="space-y-8">
                        {steps.map((step, index) => (
                            <div
                                key={step.number}
                                className={`flex flex-col md:flex-row items-start gap-8 p-8 rounded-2xl ${index % 2 === 0 ? 'bg-gray-50 dark:bg-white/5' : 'bg-[#ea184a]/5'} border border-gray-200 dark:border-white/10`}
                            >
