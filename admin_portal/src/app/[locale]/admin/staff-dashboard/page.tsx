...
const { admin, loading: adminLoading } = useAdmin();
 ...
 <div className="text-muted-foreground/80 text-sm">{t('pasif')}</div>
 )}
 ...
 <thead>
 <tr className="text-left text-muted-foreground/80 border-b border-border">
 ...
 {/* Staff Info Footer */}
 <div className="mt-4 pt-4 border-t border-border/50 flex flex-wrap items-center gap-4 text-xs text-muted-foreground/80">
 ...
 className="text-muted-foreground/80 hover:text-foreground text-xs transition"
 >
