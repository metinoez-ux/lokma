...
function CategoriesPageContent() {
 ...
 <button
 onClick={openAdd}
 className="px-4 py-2 bg-card hover:bg-card rounded-lg font-medium transition"
 >
 + {t('new_category')}
 </button>
 </div>
 ...
 disabled={index === 0}
 className="text-muted-foreground/80 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition"
 title={t('move_up')}
 >
 ▲
 </button>
