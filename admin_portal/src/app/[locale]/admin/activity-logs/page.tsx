...
export default function CustomerServicePage() {
 ...
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase hover:text-muted-foreground transition-colors">{t('user_card.email')}</p>
 <p className="text-gray-200 font-medium truncate" title={business.email}>{business.email || '-'}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase hover:text-muted-foreground transition-colors">{t('user_card.phone')}</p>
 <p className="text-gray-200 font-medium">{business.phoneNumber || '-'}</p>
 </div>
 <div className="sm:col-span-2">
 <p className="text-muted-foreground/80 text-xs uppercase hover:text-muted-foreground transition-colors">{t('order_card.address')}</p>
 ...
 <span className="text-xs px-2.5 py-0.5 rounded-full bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 uppercase tracking-wider">
 ...
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase">{t('user_card.email')}</p>
 <p className="text-gray-200 font-medium truncate" title={user.email}>{user.email || '-'}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase">{t('user_card.phone')}</p>
 <p className="text-gray-200 font-medium">{user.phoneNumber || '-'}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase">{t('user_card.registered')}</p>
 <p className="text-foreground">{user.createdAt ? new Date(user.createdAt).toLocaleDateString() : '-'}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase">{t('user_card.app_lang')}</p>
 ...
 <span className="text-muted-foreground/80 shrink-0 ml-2">{ro.createdAt ? new Date(ro.createdAt).toLocaleDateString() : '-'}</span>
 </div>
 <div className="flex justify-between items-center text-xs mt-1.5 pt-1.5 border-t border-border/30">
 <span className="px-2 py-0.5 rounded bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 uppercase shrink-0 text-[10px]">{ro.type}</span>
 ...
 <div className="text-center py-8 text-muted-foreground/80 border border-dashed border-border rounded-xl">
 No users match
 </div>
 )}
 </div>
 ...
 #{order.orderNumber}
 <span className="text-xs px-2 py-0.5 rounded-full bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 font-normal">
 ...
 <div>
 <p className="text-muted-foreground/80 text-xs uppercase">{t('order_card.customer')}</p>
 ...
 <div className="sm:col-span-2">
 <p className="text-muted-foreground/80 text-xs uppercase">{t('order_card.address')}</p>
 <p className="text-foreground leading-snug">
 {order.address
 ...
 <p className="text-sm text-muted-foreground/80 mt-1">ID: {selectedOrder.id}</p>
 </div>
 <button
 ...
 <p className="text-xs text-muted-foreground/80 uppercase">{t('order_card.customer')}</p>
 ...
 <div className="bg-card/50 p-4 rounded-xl border border-border/50">
 <p className="text-xs text-muted-foreground/80 uppercase">{t('order_card.business')}</p>
 ...
 <div>
 <p className="text-xs text-muted-foreground mb-1">{t('order_card.total')}</p>
 ...
 <div>
 <p className="text-xs text-muted-foreground mb-1">{t('payment_method')}</p>
 <p className="text-white capitalize">{selectedOrder.paymentMethod || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-muted-foreground mb-1">{t('payment_status')}</p>
 ...
 <div className="mb-4">
 <p className="text-xs text-muted-foreground/80 mb-1">{t('kurier_name')}</p>
 <p className="text-foreground">{selectedOrder.courierName}</p>
 </div>
 )}
 {selectedOrder.photoUrl && (
 <div>
 <p className="text-xs text-muted-foreground/80 mb-2">{t('pod_photo')}</p>
 ...
 className="bg-card border border-red-900/50 rounded-lg px-4 py-2 text-sm text-foreground focus:outline-none focus:border-red-500 flex-1 placeholder:text-muted-foreground"
 />
 <button
