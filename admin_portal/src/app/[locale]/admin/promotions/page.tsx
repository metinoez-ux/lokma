...
function PromotionsPageContent() {
 ...
 className={`px-4 py-2 rounded-lg font-medium transition ${canCreateCampaign ? 'bg-card hover:bg-card ' : 'bg-card opacity-50 cursor-not-allowed'}`}
 ...
 <span className="ml-2 text-muted-foreground/80 font-normal text-xs">{t('everyOrderActive')}</span>
 </label>
 <div className="flex items-center gap-3">
 ...
 {loadingProducts ? (
 <div className="flex items-center gap-2 text-muted-foreground/80 text-sm py-4">
 <div className="animate-spin w-4 h-4 border-2 border-gray-600 border-t-emerald-500 rounded-full" />
 {t('productsLoading')}
 </div>
 ) : businessProducts.length === 0 ? (
 <div className="text-center py-6 text-muted-foreground/80 text-sm border border-dashed border-border rounded-xl">
 ...
 <span className={`text-lg flex-shrink-0 ${isSelected ? 'text-emerald-800 dark:text-emerald-400' : 'text-muted-foreground'}`}>
 {isSelected ? '✓' : '○'}
 </span>
 </button>
 );
 ...
 <span className="text-muted-foreground/80 block mt-1">{t('yourPlan')}: <strong className="text-foreground">{businessPlanName}</strong></span>
 </p>

 {templates.length === 0 ? (
 <p className="text-muted-foreground/80 text-center py-8">{t('noTemplatesYet')}</p>
 ) : (
 ...
 <h3 className={`font-semibold ${tierAllowed ? 'text-white' : 'text-muted-foreground/80'}`}>
 ...
 className="px-3 py-2 bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 rounded-lg text-xs hover:bg-gray-600 transition"
 >
 {t('cancel')}
 </button>
 </div>
 ...
 />
 <p className="text-muted-foreground/80 text-xs mt-1">{t('cashbackDesc')}</p>
 </div>
 </div>
 )}
 ...
 <p className="text-muted-foreground/80 text-xs mt-1">{t('segmentOnlyNote')}</p>
 </div>
 )}
 ...
 className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500"
 />
 <p className="text-muted-foreground/80 text-xs mt-1">{t('bundleProductsNote')}</p>
 </div>
 </div>
 </div>
 )}
 ...
 <p className="text-muted-foreground/80 text-xs mt-2">{t('cartBoosterExample')}</p>
 </div>
 )}
 ...
 />
 <p className="text-muted-foreground/80 text-xs mt-1">{t('productDiscountNote')}</p>
 </div>
 </div>
 )}
 ...
 <div className="grid grid-cols-1 gap-3">
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('validCategories')}</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('validProductIds')}</label>
 <input
 type="text"
 ...
 <div className="grid grid-cols-2 gap-3">
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('totalMaxUsage')}</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('perUserTotal')}</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('dailyLimit')}</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('weeklyLimit')}</label>
 <input
 type="number"
 ...
 <label className="text-muted-foreground/80 text-xs mb-1 block">{t('perUserDailyLimit')}</label>
 <input
 type="number"
