...
export default function InvoicesPage() {
 ...
 <tr>
 <td colSpan={7} className="px-4 py-12 text-center text-muted-foreground/80">
 ...
 <p className="text-muted-foreground/80 text-xs">{invoice.butcherAddress}</p>
 </div>
 </td>
 ...
 rows={3}
 />
 <p className="text-muted-foreground/80 text-xs mt-1">{stornoReason.length}/10 karakter</p>
 </div>
