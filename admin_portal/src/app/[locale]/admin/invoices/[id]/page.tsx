                                ...
                                {(invoice as any).lexwareInvoiceId && (
                                    <>
                                        ...
                                        {(invoice as any).lexwareSentAt && (
                                            <div>
                                                <span className="text-gray-500 text-xs">{t('sentToLexware')}</span>
                        ...
                        <div className="bg-card rounded-xl p-5">
                            ...
                            <div className="space-y-3">
                                {invoice.paymentMethod && (
                                    <div>
                                        <span className="text-gray-500 text-xs">{t('paymentMethod')}</span>
                ...
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                    <div className="bg-card rounded-xl p-6 w-full max-w-md mx-4">
                        ...
                        <div className="mb-4">
                            ...
                            />
                            <p className="text-gray-500 text-xs mt-1">{stornoReason.length}/10 {t('charsMinimum')}</p>
                        </div>
