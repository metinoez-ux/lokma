...
export default function FuneralMembersPage() {
 ...
 <tr><td colSpan={7} className="text-center py-12 text-muted-foreground/80">{t('uye_bulunamadi')}</td></tr>
 ...
 <div className="text-xs text-muted-foreground/80">{m.personalInfo.placeOfBirth}, {new Date(m.personalInfo.dateOfBirth).getFullYear()}</div>
 </td>
