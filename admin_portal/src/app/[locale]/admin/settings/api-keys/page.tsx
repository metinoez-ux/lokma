...
export default function ApiKeysPage() {
 ...
 <span className="text-muted-foreground/80 text-xs font-medium">{t('keyLabel')}</span>
 ...
 className="px-4 py-2 bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 rounded-xl text-sm hover:bg-gray-600 transition-all"
 >
 {t('cancel')}
 </button>
 </div>
