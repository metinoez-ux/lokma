...
export default function PrinterSettingsPage() {
 ...
 <p className="text-xs text-muted-foreground/80 mt-0.5">Bon-Drucker für die Bestellverarbeitung aktivieren</p>
 </div>
 <button
 ...
 >
 <div className={`absolute top-0.5 w-6 h-6 bg-card rounded-full shadow transition-transform ${settings.enabled ? 'translate-x-7' : 'translate-x-0.5'}`} />
 </button>
 </div>
 ...
 className="w-full px-4 py-3 bg-background text-foreground rounded-xl border border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition placeholder:text-muted-foreground"
 />
 <p className="text-xs text-muted-foreground mt-1">Die lokale Netzwerkadresse Ihres Druckers</p>
 </div>
 <div>
 ...
 />
 <p className="text-xs text-muted-foreground mt-1">Standard: 9100 (ESC/POS)</p>
 </div>
 </div>
 ...
 className="flex-1 px-4 py-3 bg-background text-foreground rounded-xl border border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition placeholder:text-muted-foreground font-mono text-sm"
 />
 <button
 ...
 <p className="text-xs text-muted-foreground/80 mb-1">Status</p>
 ...
 <div className="bg-background/50 rounded-xl p-4">
 <p className="text-xs text-muted-foreground/80 mb-1">Antwortzeit</p>
 <p className="font-bold text-sm text-foreground">{health.responseTimeMs ? `${health.responseTimeMs}ms` : '—'}</p>
 </div>
 <div className="bg-background/50 rounded-xl p-4">
 <p className="text-xs text-muted-foreground/80 mb-1">Letzte Prüfung</p>
 <p className="font-bold text-sm text-foreground">
 {health.lastChecked ? health.lastChecked.toLocaleTimeString('de-DE') : '—'}
 </p>
 </div>
 <div className="bg-background/50 rounded-xl p-4">
 <p className="text-xs text-muted-foreground/80 mb-1">Adresse</p>
 ...
 : !settings.enabled || !settings.printerIp
 ? 'bg-gray-700 text-muted-foreground/80 cursor-not-allowed'
