...
export default function FreeDrinkSettingsPage() {
 ...
 {loadingProducts ? (
 <div className="flex items-center justify-center py-10 text-muted-foreground/80 text-sm">
 <span className="animate-spin mr-2">⏳</span> Ürünler yükleniyor…
 </div>
 ) : products.length === 0 ? (
 <div className="text-center py-8 text-muted-foreground/80 text-sm border border-dashed border-border rounded-xl">
 <p className="text-2xl mb-2">🧃</p>
 <p>Menünüzde henüz içecek ürünü yok.</p>
 <p className="text-xs mt-1 text-muted-foreground">Menü &gt; Ürünler bölümünden içecek ekleyin.</p>
 </div>
 ) : (
