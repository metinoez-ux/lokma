...
export default function IoTSettingsPage() {
 ...
 <p className="text-xs text-muted-foreground/80">{t('tum_iot_bildirimlerini_acar_kapatir')}</p>
 </div>
 ...
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{t('lokma_iot_gateway_in_calistigi_sunucu_ad')}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('tts_ile_sesli_siparis_bildirimi')}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('wled_kayitli_led_flash')}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('admin_panelde_gong_calar')}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('kirmizi_ekran_yanip_soner')}</p>
 </div>
 ...
 className="px-4 bg-muted/50 hover:bg-gray-300 text-foreground/90 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 font-bold py-2.5 rounded-lg transition text-sm"
 >
 {t('iptal') || 'İptal'}
 </button>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('siparisler_icin_bon_yazdirma') || 'Siparişler için bon yazdırma'}</p>
 </div>
 <label className="relative inline-flex items-center cursor-pointer">
 ...
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{t('yazici_wifi_ip') || 'Yazıcının WiFi ağındaki IP adresi (Yazıcı ayarlarından öğrenebilirsiniz)'}</p>
 </div>
 ...
 placeholder="9100"
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{t('standart_port_9100') || 'Standart ESC/POS port: 9100'}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80">{t('yeni_siparis_gelince_otomatik') || 'Yeni sipariş gelince otomatik bas'}</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground/80 mb-2">{t('mutfak_surucü_kasa') || 'Mutfak + Sürücü + Kasa'}</p>
 <div className="flex items-center gap-3">
 <button
 onClick={() => setPrintCopies(Math.max(1, printCopies - 1))}
 className="w-8 h-8 rounded-lg bg-muted/50 hover:bg-gray-300 text-foreground/90 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 font-bold"
 >−</button>
