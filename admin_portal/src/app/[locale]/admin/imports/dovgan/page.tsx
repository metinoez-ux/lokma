...
export default function DovganImportPage() {
 ...
 <p className="mt-4 text-muted-foreground">{t('urunler_yukleniyor')}</p>
 </div>
 </div>
 </div>
 );
 ...
 className="px-3 py-1 text-sm bg-muted hover:bg-muted/50 rounded"
 >
 {t('tumunu_sec')}
 </button>
 <button
 ...
 <div className="text-3xl font-bold text-foreground/80">{results.skipped}</div>
 <div className="text-sm text-muted-foreground">{t('atlanan')}</div>
 </div>
 </div>
 )}
