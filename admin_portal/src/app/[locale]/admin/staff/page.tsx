...
export default function StaffRedirectPage() {
 ...
 return (
 <div className="min-h-screen bg-card dark:bg-gray-950 flex flex-col items-center justify-center p-4 transition-colors duration-200">
 <div className="text-center max-w-sm w-full bg-muted/30 dark:bg-background border border-border/50 dark:border-border rounded-2xl p-8 shadow-xl">
 {/* Modern Theme-Aware Logo */}
 <div className="flex items-center justify-center gap-2 mb-8">
 <span className="text-4xl font-black tracking-tighter text-foreground ">LOKM</span>
 ...
 <div className="absolute inset-0 border-4 border-border/50 dark:border-border rounded-full"></div>
