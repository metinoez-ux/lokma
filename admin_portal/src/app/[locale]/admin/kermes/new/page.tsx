...
function NewKermesContent() {
 ...
 <p className="text-sm text-muted-foreground/80 mt-1">{organization.address}</p>
 )}
 </div>
 <button
 type="button"
 ...
 />
 <p className="text-xs text-muted-foreground/80 mt-1">{t('adres_ulke_otomatik')}</p>
 </div>
 ...
 <p className="text-muted-foreground/80 text-sm">Özellikler yükleniyor...</p>
 ...
 ? 'text-white border-2'
 : 'bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 border-2 border-gray-600 hover:border-gray-500'
 }`}
