              ...
              <>
                ...
                <div className="bg-card rounded-xl p-6">
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${(kermes as any).acceptsDonations ? 'bg-green-600/30 text-green-400' : 'bg-gray-600/30 text-gray-400'
                        }`}>
                ...
                <div className="bg-card rounded-xl p-6">
                  ...
                  {isEditing ? (
                    ...
                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${(kermes as any).isSilaYolu ? 'bg-emerald-600/30 text-emerald-400' : 'bg-gray-600/30 text-gray-400'
                      }`}>
                              ...
                              <div className="flex gap-1 ml-2">
                                {[
                                  ...
                                  <button
                                    ...
                                    className={`px-2 py-0.5 text-xs rounded-full border transition ${(loc.status || null) === opt.key
            ...
            <div className="bg-card rounded-xl p-6">
                  ...
                  {!matchedUser && (
                    <>
                      <button
                        ...
                        className={`w-full py-2.5 text-white text-sm font-semibold rounded-lg transition ${isCreatingUser || !newStaffForm.name || (!newStaffForm.phone && !newStaffForm.email) || !newStaffForm.gender
                          ...
                          <div key={user.id} className="border-b border-border last:border-0">
                            <div className="flex items-start gap-3 px-4 py-3">
                              ...
                              <button
                                ...
                                className={`flex-shrink-0 mt-1 px-3 py-1.5 text-xs font-semibold rounded-lg transition ${alreadyAssigned
              ...
              <div className="space-y-2">
                {assignedStaffDetails.map(staff => (
                  <div key={staff.id} className={`flex flex-col md:flex-row md:items-center justify-between gap-3 px-4 py-3 rounded-lg border ${staff.gender === 'female'
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      {staff.photoURL || staff.profileImageUrl ? (
                        ...
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${staff.gender === 'female'
                    ...
                    <div className="flex flex-wrap items-center justify-start md:justify-end gap-2 md:w-auto flex-shrink-0">
                      <button
                        ...
                        className={`w-7 h-7 rounded-sm overflow-hidden flex items-center justify-center text-xs font-semibold transition-colors ${assignedWaiters.includes(staff.id)
                      ...
                      <button
                        ...
                        className={`w-7 h-7 rounded-sm flex items-center justify-center text-xs font-semibold transition-colors ${assignedDrivers.includes(staff.id)
                      ...
                      {(editForm.customRoles || []).map(r => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-7 h-7 rounded-sm flex items-center justify-center text-sm transition-colors border ${isAssigned
                      ...
                      {canManageStaff && (
                        <button
                          ...
                          className={`w-7 h-7 rounded-sm flex items-center justify-center text-xs font-bold transition-colors border ${kermesAdmins.includes(staff.id)
                          ...
                          <div key={product.id} className={`bg-gray-700 rounded-lg p-3 ${!product.isAvailable ? 'opacity-60' : ''}`}>
                            <div className="flex items-center justify-between cursor-pointer hover:bg-gray-600/50 rounded -m-1 p-1 transition"
                              ...
                              <div className="flex items-center gap-3">
                                {product.imageUrls && product.imageUrls.length > 0 ? (
                                  <img src={product.imageUrls[0]} alt={product.name} className="w-8 h-8 rounded-lg object-cover border border-gray-600" />
                                ) : (
                                  <div className="w-8 h-8 rounded-lg bg-gray-600/50 border border-gray-500/50 flex items-center justify-center">
                            ...
                            <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-600" onClick={(e) => e.stopPropagation()}>
                              ...
                              <button
                                ...
                                className={`px-2 py-1 rounded text-xs flex items-center gap-1 ${product.stockEnabled
                              ...
                              {product.stockEnabled && (
                                <>
                                  ...
                                  <span className={`text-xs px-2 py-1 rounded ${(product.currentStock || 0) <= (product.lowStockThreshold || 5) && (product.currentStock || 0) > 0
                      ...
                      {salesHistoryData.slice(0, 20).map((sale: any, i: number) => (
                        <div key={sale.id || i} className="flex items-center justify-between text-xs text-muted-foreground py-1 border-b border-gray-700 last:border-0">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-1.5 py-0.5 rounded text-xs ${sale.section?.includes('K') ? 'bg-pink-900/40 text-pink-300' :
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition border ${editPersonData.gender === 'male'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition border ${editPersonData.gender === 'female'
                ...
                {(editForm.customRoles || []).length > 0 && (
                  <>
                    ...
                    {(editForm.customRoles || []).map((role: any) => {
                      ...
                      return (
                        <div key={role.id} className={`flex items-center justify-between p-3 mb-2 rounded-lg border transition-colors ${isAssigned
                          ...
                          <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isAssigned ? 'bg-purple-500' : 'bg-gray-300 dark:bg-gray-600'
                              }`}
                          >
                            <span className={`inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform ${isAssigned ? 'translate-x-6' : 'translate-x-1'
                              }`} />
                          </button>
                        ...
                        if (email) {
                          ...
                          const res = await fetch("/api/email/send", {
                            ...
                            body: JSON.stringify({
                              ...
                              html: `<div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px;background:#f9fafb;border-radius:12px;border:1px solid #e5e7eb"><h2 style="color:#1e40af;margin-top:0">Merhaba ${editPersonData.displayName || editPersonData.firstName || editPersonData.name || "Personel"}</h2><p>Kermes personel panelinize giris yapmak icin lutfen asagidaki bilgileri kullanin:</p><p><strong>Benutzername (Login):</strong> ${email}</p><p><strong>Passwort (Şifre):</strong> <span style="background-color:#ffe4e6;color:#e11d48;padding:4px 8px;border-radius:4px;font-family:monospace;font-size:16px;">${tempPassword}</span></p><p><strong>Link:</strong> <a href="${window.location.origin}/login">${window.location.origin}/login</a></p><p>Eger sifrenizi degistirmek isterseniz, giris sayfasindan "Sifremi Unuttum" secenegini kullanabilirsiniz.</p><hr style="border:none;border-top:1px solid #e5e7eb;margin:16px 0"><p style="color:#6b7280;font-size:12px">LOKMA Kermes Yonetim Sistemi</p></div>`
                            })
                          });
                          if (res.ok) {
