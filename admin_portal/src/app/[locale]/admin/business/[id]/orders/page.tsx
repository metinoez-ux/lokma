...
const params = useParams();
 ...
 <div className="w-10 h-10 bg-background/20 rounded-full flex items-center justify-center text-xl shadow-inner">
 🍽️
 </div>
 <div>
 ...
 {/* Status Filter */}
 <div>
 <label className="block text-xs text-muted-foreground/80 mb-1">{t('durum')}</label>
 <select
 value={statusFilter}
 onChange={(e) => setStatusFilter(e.target.value)}
 className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-red-500"
 >
 ...
 {/* Date Range */}
 <div>
 <label className="block text-xs text-muted-foreground/80 mb-1">{t('baslangic')}</label>
 <input
 type="date"
 value={dateFrom}
 ...
 <div>
 <label className="block text-xs text-muted-foreground/80 mb-1">{t('bitis')}</label>
 <input
 type="date"
 value={dateTo}
 ...
 {/* Amount Range */}
 <div>
 <label className="block text-xs text-muted-foreground/80 mb-1">{t('tutar')}</label>
 ...
 className="w-1/2 border border-border rounded-lg px-2 py-2 text-sm focus:ring-2 focus:ring-red-500"
 />
 <input
 type="number"
 placeholder="Max"
 ...
 {!order.paymentMethod && <span className="text-muted-foreground/80">💵 Nakit</span>}
 </div>
 </td>
 <td
 className="px-4 md:px-6 py-4 whitespace-nowrap"
 ...
 <div className="mb-4">
 <label className="block text-sm font-medium text-foreground/80 mb-2">{t('rejection_reason')}</label>
 <textarea
 value={rejectReason}
 ...
 className="flex-1 px-4 py-2 bg-muted/50 text-foreground/80 rounded-lg hover:bg-gray-300"
 >
 İptal
 </button>
 <button
...
function EditOrderModal({
 ...
 <tr>
 <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground/80">{t('product')}</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground/80">{t('quantity_kg')}</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground/80">{t('price_kg')}</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground/80">{t('total')}</th>
 ...
 <button
 onClick={addItem}
 className="w-full py-2 border-2 border-dashed border-border rounded-lg text-muted-foreground/80 hover:border-purple-500 hover:text-purple-500 mb-4"
 >
 + Yeni Ürün Ekle
 </button>
