...
export default function HardwareTabContent({
  ...
  const hardwareList: any[] = [
...

    {
      ...
      description: "Müşteriye sepet tutarını göstermek, dijital fiş sunmak veya sadakat programı entegrasyonu sağlamak için kullanılan interaktif müşteri ekranıdır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/cpad-pay/icon/cpad-pay.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/cpad-pay/icon/cpad-pay.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/CPad/icon/CPad.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Ödeme ve fiş yazdırma yeteneklerini esnek ve hafif bir form faktöründe birleştiren, kuryeler ve saha satış personeli için tasarlanmış pratik cihazdır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/flex-3/icon/flex-3.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/flex-3/icon/flex-3.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Restoran, kafe ve paket servis süreçleri için tasarlanmış, entegre fiş yazıcılı, yüksek performanslı ve taşınabilir akıllı POS terminalidir. Hızlı sipariş alma ve anında fiş kesme imkanı sunar.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/v3-plus/icon/v3-plus.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/v3-plus/icon/v3-plus.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/v3e/icon/v3e.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/v3-family/icon/v3-family.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/v3-mix/icon/v3-mix.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/1/V2PRO.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/1/V2sPLUS.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/1/V2s.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Zorlu depo ve mağaza ortamları için suya ve düşmeye dayanıklı (IP67/IP68), yüksek hızlı barkod okuyuculu endüstriyel el terminalidir. Yoğun stok sayımı ve depo yönetimi için idealdir.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/l3/icon/l3.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/l3/icon/l3.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/l2s-pro/icon/l2s-pro.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/l2ks/icon/l2ks.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/l2h/icon/l2h.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Kompakt, hafif ve ince tasarımıyla garsonların masa başında veya reyon görevlilerinin mağaza içinde sipariş almasını kolaylaştıran taşınabilir el terminalidir.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/m3/icon/m3.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/m3/icon/m3.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/1/M2MAX.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/p3-air/icon/p3-air.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    ...
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/p3-mix/icon/p3-mix.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/2/P2LITESE.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/2/p2se.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/2/P2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/2/P2SMARTPAD.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Yoğun restoran ve perakende işletmeleri için tasarlanmış, güçlü işlemcisi ve entegre yazıcısıyla kesintisiz çalışan, müşteri ekranı opsiyonlu profesyonel masaüstü kasa sistemidir.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/t3-family/icon/t3-family.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/t3-family/icon/t3-family.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/t3-pro/icon/t3-pro-series.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/T2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/T2LITE.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    ...
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/T2MINI.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Dar tezgah alanına sahip butik işletmeler için ideal, şık ve az yer kaplayan kompakt masaüstü Android kasa çözümüdür.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/d3-family/icon/d3-family.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/d3-family/icon/d3-family.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/d3-pro/icon/d3-pro.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/d3-mini/icon/d3-mini.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/d2s-kds/icon/product.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/d2s-plus-combo/icon/product.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/d2s-plus/icon/product.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/D2SCOMBO.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/D2S.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/D2SLITE.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/D2MINI.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Manav, kasap, şarküteri ve kuruyemiş gibi tartımlı ürün satan işletmeler için fiş/etiket yazıcı entegreli, hassas sensörlü akıllı terazi sistemidir.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/S2.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/S2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Büyük mağaza ve süpermarket kasaları için yüksek tartım kapasitesine ve hızlı barkod okuma teknolojisine sahip entegre kasa çözümüdür.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/ft2.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/3/ft2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Müşterilerin kendi siparişlerini ve ödemelerini kolayca yapabilmesi için tasarlanmış, temassız ödeme destekli ve fiş yazıcılı self-servis sipariş (kiosk) sistemidir.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/4/K2.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/4/K2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/4/K2MINI.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Mutfak, bar veya paket servis alanlarında sipariş fişlerini ve yapışkanlı etiketleri hızlı, sessiz ve yüksek kalitede basabilen endüstriyel yazıcılardır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/80-label-printer/icon/80-label-printer.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/80-label-printer/icon/80-label-printer.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "İşletmenin tüm sipariş ve POS trafiğini kesintisiz ve yüksek hızda yönlendirmek için tasarlanmış kurumsal ağ (Wi-Fi/4G) istasyonlarıdır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/mini-ap/icon/mini-ap.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/mini-ap/icon/mini-ap.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/5/w1s.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/80-kitchen-printer/icon/80-printer.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Dijital raf etiketleri (ESL) ile fiyatlarınızı bulut üzerinden tek tuşla, sıfır kağıt israfıyla güncelleyin.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/5/ESL.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/5/ESL.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Kasa noktalarında QR kodları, 1D/2D barkodları ve mobil cihaz ekranlarındaki kodları saniyenin altında bir sürede okuyabilen yüksek hassasiyetli tarayıcılardır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/blink2/icon/blink2.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/blink2/icon/blink2.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      description: "Kasa çekmecesi, barkod okuyucu standı, batarya ve POS klavyesi gibi LOKMA donanım ekosistemini tamamlayan profesyonel aksesuarlardır.",
      icon: <Monitor className="w-8 h-8 text-blue-400" />,
      image: "https://file.cdn.sunmi.com/newebsite/products/sound-box/icon/sound-box.png",
      images: ["https://file.cdn.sunmi.com/newebsite/products/sound-box/icon/sound-box.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/max-cash-drawer/icon/max-cash-drawer-v1.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/6/scanner.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/6/scannergun.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/6/charger.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/6/keyword.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    {
      ...
      images: ["https://file.cdn.sunmi.com/newebsite/products/list/xl/icons/6/moneybox-v1.png"],
      price: 299,
      rentPrice: 19.9,
      minRentMonths: 12
    },
    ...
    { id: "esl_sg_21b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag21B", category: "ESL Etiketleri", description: "2.1 inç (5.3 cm) 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket, süper hızlı güncelleme.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d14338531dd.png", price: 13.90, rentPrice: 1.00, minRentMonths: 12, specs: ["2.1 inç (5.3 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 2.1, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_26b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag26B", category: "ESL Etiketleri", description: "2.6 inç (6.6 cm) 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket, süper hızlı güncelleme.", image: "https://www.minewtag.com/upload/goodsgallery/2024-06/666188b221228.jpg", price: 16.90, rentPrice: 1.20, minRentMonths: 12, specs: ["2.6 inç (6.6 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 2.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_42b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag42B", category: "ESL Etiketleri", description: "4.2 inç (10.7 cm) büyük boy 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142b76297d.png", price: 27.90, rentPrice: 2.30, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 4.2, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_58b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag58B", category: "ESL Etiketleri", description: "5.8 inç (14.7 cm) geniş format 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d14298d25a9.png", price: 42.90, rentPrice: 3.30, minRentMonths: 12, specs: ["5.8 inç (14.7 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 5.8, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_75b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag75B", category: "ESL Etiketleri", description: "7.5 inç (19.1 cm) geniş format 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d013939009d.png", price: 62.90, rentPrice: 4.50, minRentMonths: 12, specs: ["7.5 inç (19.1 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 7.5, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_116b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag116B", category: "ESL Etiketleri", description: "11.6 inç (29.5 cm) devasa 3 renk (Siyah-Beyaz-Kırmızı) destekli ekran.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142588faa9.png", price: 85.90, rentPrice: 5.50, minRentMonths: 12, specs: ["11.6 inç (29.5 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 11.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },

    { id: "esl_sg_116", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag116", category: "ESL Etiketleri", description: "Geniş formatlı reyon yönlendirmeleri ve devasa promosyon ekranı.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142588faa9.png", price: 89.90, rentPrice: 5.90, minRentMonths: 12, specs: ["11.6 inç (29.5 cm)", "3 Renkli Ekran", "5 Yıl Pil"], filters: { size: 11.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_58", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag58", category: "ESL Etiketleri", description: "Büyük ürün detayları gösterebilen yüksek çözünürlüklü etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d14298d25a9.png", price: 44.90, rentPrice: 3.50, minRentMonths: 12, specs: ["5.8 inç (14.7 cm)", "3 Renk Desteği"], filters: { size: 5.8, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_58q", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag58Q", category: "ESL Etiketleri", description: "4 renk kapasitesiyle daha canlı görünüm.", image: "https://www.minewtag.com/upload/goodsgallery/2025-04/67fe104c8cc89.jpg", price: 49.90, rentPrice: 3.90, minRentMonths: 12, specs: ["5.8 inç (14.7 cm)", "4 Renkli"], filters: { size: 5.8, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_sg_42", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag42", category: "ESL Etiketleri", description: "Standart büyük boy etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142b76297d.png", price: 29.90, rentPrice: 2.50, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "3 Renkli"], filters: { size: 4.2, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_42q", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag42Q", category: "ESL Etiketleri", description: "4.2 inç (10.7 cm) formatında 4 farklı renk kapasitesi.", image: "https://www.minewtag.com/upload/goodsgallery/2025-04/67fe11564ffc2.jpg", price: 34.90, rentPrice: 2.80, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "4 Renk"], filters: { size: 4.2, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_sg_29aq", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag29AQ", category: "ESL Etiketleri", description: "Market rafları için Premium kasa ve gelişmiş AQ seri.", image: "https://www.minewtag.com/upload/goodsgallery/2025-08/6895746442731.jpg", price: 22.90, rentPrice: 1.80, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "Premium"], filters: { size: 2.9, tech: ["Bluetooth", "NFC"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_29", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag29", category: "ESL Etiketleri", description: "Standart 2.9 inç (7.4 cm) market etiketi.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142f92b942.png", price: 19.90, rentPrice: 1.50, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "3 Renkli"], filters: { size: 2.9, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_29q", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag29Q", category: "ESL Etiketleri", description: "2.9 inç (7.4 cm) boyutunda 4 renk kapasitesi.", image: "https://www.minewtag.com/upload/goodsgallery/2025-04/67fe12511deb9.png", price: 21.90, rentPrice: 1.60, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "4 Renk"], filters: { size: 2.9, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_sg_29b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag29B", category: "ESL Etiketleri", description: "3 renk (Siyah-Beyaz-Kırmızı) desteği, süper hızlı güncelleme.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142f92b942.png", price: 17.90, rentPrice: 1.30, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 2.9, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_26", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag26", category: "ESL Etiketleri", description: "Sıkışık raflar için 2.6 inç (6.6 cm) model.", image: "https://www.minewtag.com/upload/goodsgallery/2024-06/666188b221228.jpg", price: 17.90, rentPrice: 1.30, minRentMonths: 12, specs: ["2.6 inç (6.6 cm)", "3 Renkli"], filters: { size: 2.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_26q", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag26Q", category: "ESL Etiketleri", description: "Küçük form faktörde 4 renk.", image: "https://www.minewtag.com/upload/goodsgallery/2025-04/67fe12af9e8e5.png", price: 19.90, rentPrice: 1.50, minRentMonths: 12, specs: ["2.6 inç (6.6 cm)", "4 Renk"], filters: { size: 2.6, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_sg_29ab", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag29AB", category: "ESL Etiketleri", description: "2.9 inç (7.4 cm) AB (Advanced) varyasyonu.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142f92b942.png", price: 23.90, rentPrice: 1.80, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "Advanced"], filters: { size: 2.9, tech: ["Bluetooth", "NFC"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_21f", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag21F", category: "ESL Etiketleri", description: "Dondurucu için optimize edilmiş 2.1 inç (5.3 cm) etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-06/6661856043454.jpg", price: 18.90, rentPrice: 1.40, minRentMonths: 12, specs: ["2.1 inç (5.3 cm)", "Soğuk Hava (-25°C)"], filters: { size: 2.1, tech: ["Bluetooth", "NFC"], colors: 3, cold: true, water: false } },
    { id: "esl_sg_21", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag21", category: "ESL Etiketleri", description: "Kozmetik reyonları için keskin 2.1 inç (5.3 cm) etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d14338531dd.png", price: 14.90, rentPrice: 1.10, minRentMonths: 12, specs: ["2.1 inç (5.3 cm)", "3 Renkli"], filters: { size: 2.1, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_21q", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag21Q", category: "ESL Etiketleri", description: "Mini boyutta 4 renk özelliği.", image: "https://www.minewtag.com/upload/goodsgallery/2025-04/67fe1375c32c2.png", price: 16.90, rentPrice: 1.20, minRentMonths: 12, specs: ["2.1 inç (5.3 cm)", "4 Renk"], filters: { size: 2.1, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    ...
    { id: "esl_ds_116", series: "DS Slim Series", name: "LOKMA Smart Tag DS116", category: "ESL Etiketleri", description: "Ultra ince 11.6 inç (29.5 cm) signage modeli.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d013fb9239f.png", price: 89.90, rentPrice: 5.90, minRentMonths: 12, specs: ["11.6 inç (29.5 cm)", "Ultra Slim"], filters: { size: 11.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_ds_043q", series: "DS Slim Series", name: "LOKMA Smart Tag DS043Q", category: "ESL Etiketleri", description: "4.3 inç (10.9 cm) grafik display ince model.", image: "https://www.minewtag.com/upload/goodsgallery/2025-09/68c388545f05f.jpg", price: 36.90, rentPrice: 2.80, minRentMonths: 12, specs: ["4.3 inç (10.9 cm)", "Slim", "4 Renk"], filters: { size: 4.3, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_ds_042q", series: "DS Slim Series", name: "LOKMA Smart Tag DS042Q", category: "ESL Etiketleri", description: "4.2 inç (10.7 cm) ince kasa 2.5D şeffaf korumalı.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d13d5963cb9.png", price: 31.90, rentPrice: 2.60, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "Slim"], filters: { size: 4.2, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_ds_042f", series: "DS Slim Series", name: "LOKMA Smart Tag DS042F", category: "ESL Etiketleri", description: "IP67 korumalı ince seri model.", image: "https://www.minewtag.com/upload/goodsgallery/2025-08/68afbfc42f4bf.jpg", price: 34.90, rentPrice: 2.70, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "IP67", "Slim"], filters: { size: 4.2, tech: ["Bluetooth", "NFC"], colors: 3, cold: false, water: true } },
    { id: "esl_ds_035q", series: "DS Slim Series", name: "LOKMA Smart Tag DS035Q", category: "ESL Etiketleri", description: "3.5 inç (8.9 cm) ince kasa modeli.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d13e594f9b9.png", price: 26.90, rentPrice: 2.10, minRentMonths: 12, specs: ["3.5 inç (8.9 cm)", "Slim"], filters: { size: 3.5, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_ds_035b", series: "DS Slim Series", name: "LOKMA Smart Tag DS035B", category: "ESL Etiketleri", description: "Siyah beyaz 3.5 inç (8.9 cm) ince kasa modeli.", image: "https://www.minewtag.com/upload/goodsgallery/2025-09/68c37f463503f.jpg", price: 24.90, rentPrice: 1.90, minRentMonths: 12, specs: ["3.5 inç (8.9 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)", "Slim"], filters: { size: 3.5, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_ds_029q", series: "DS Slim Series", name: "LOKMA Smart Tag DS029Q", category: "ESL Etiketleri", description: "Standart market rafları için ultra ince profil.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d13eacab206.png", price: 18.90, rentPrice: 1.40, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "Slim", "4 Renk"], filters: { size: 2.9, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_ds_027q", series: "DS Slim Series", name: "LOKMA Smart Tag DS027Q", category: "ESL Etiketleri", description: "2.7 inç (6.9 cm) ara boyut ince etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2025-08/68956b8e28509.jpg", price: 17.90, rentPrice: 1.30, minRentMonths: 12, specs: ["2.7 inç (6.9 cm)", "Slim"], filters: { size: 2.7, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    { id: "esl_ds_026f", series: "DS Slim Series", name: "LOKMA Smart Tag DS026F", category: "ESL Etiketleri", description: "Sadece 7.8mm kalınlığında 2.66 inç (6.8 cm) etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2025-08/68afbe8f569e9.jpg", price: 16.90, rentPrice: 1.20, minRentMonths: 12, specs: ["2.6 inç (6.6 cm)", "7.8mm Slim"], filters: { size: 2.6, tech: ["Bluetooth", "NFC"], colors: 3, cold: false, water: false } },
    { id: "esl_ds_021q", series: "DS Slim Series", name: "LOKMA Smart Tag DS021Q", category: "ESL Etiketleri", description: "Raf alanı dar yerler için 4 renkli mini ince etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d141deb0a02.png", price: 14.90, rentPrice: 1.10, minRentMonths: 12, specs: ["2.1 inç (5.3 cm)", "4-Renk", "Slim"], filters: { size: 2.1, tech: ["Bluetooth", "NFC"], colors: 4, cold: false, water: false } },
    ...
    { id: "esl_mercurius_29", series: "Mercurius Series", name: "LOKMA Smart Tag MTag29", category: "ESL Etiketleri", description: "Butik mağazalar için tasarlanmış özel premium kasa tasarımı.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d143ceb1e71.png", price: 24.90, rentPrice: 1.80, minRentMonths: 12, specs: ["2.9 inç (7.4 cm)", "Mercurius"], filters: { size: 2.9, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    ...
    { id: "esl_conference_rs075v", series: "Conference Table Series", name: "LOKMA Smart Desk Sign RS075V", category: "ESL Etiketleri", description: "Ofis resepsiyonu ve masa numaratörleri için çift taraflı V-şeklinde ekran (6 renk destegi).", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d0120729b52.png", price: 95.90, rentPrice: 6.90, minRentMonths: 12, specs: ["7.3 inç (18.5 cm) x 2", "V-Shape", "6 Renk"], filters: { size: 7.3, tech: ["Bluetooth"], colors: 6, cold: false, water: false } },
    { id: "esl_conference_ds073", series: "Conference Table Series", name: "LOKMA Smart Desk Sign DS073", category: "ESL Etiketleri", description: "Toplantı masaları için gelişmiş ince profil isimlik.", image: "https://www.minewtag.com/upload/goodsgallery/2024-09/66e3a7cc2cbec.png", price: 85.90, rentPrice: 6.50, minRentMonths: 12, specs: ["7.3 inç (18.5 cm) Çift Taraflı"], filters: { size: 7.3, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_conference_ws075", series: "Conference Table Series", name: "LOKMA Smart Desk Sign WS075", category: "ESL Etiketleri", description: "Geniş format masaüstü elektronik bilgi levhası.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d012b6b97b3.png", price: 89.90, rentPrice: 6.70, minRentMonths: 12, specs: ["7.5 inç (19.1 cm)", "Masaüstü Stand"], filters: { size: 7.5, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_conference_stag75", series: "Conference Table Series", name: "LOKMA Smart Desk Sign STag75", category: "ESL Etiketleri", description: "Masaüstü konferans etiketlemeleri için yüksek okunaklı STag serisi model.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d013939009d.png", price: 79.90, rentPrice: 5.90, minRentMonths: 12, specs: ["7.5 inç (19.1 cm)", "Standlı"], filters: { size: 7.5, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
