...
export default function HardwareTabContent({
  ...
  const hardwareList: any[] = [
    ...
    { id: "esl_sg_42b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag42B", category: "ESL Etiketleri", description: "4.2 inç (10.7 cm) büyük boy 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142a9c8819.png", price: 27.90, rentPrice: 2.30, minRentMonths: 12, specs: ["4.2 inç (10.7 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 4.2, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    ...
    { id: "esl_sg_75b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag75B", category: "ESL Etiketleri", description: "7.5 inç (19.1 cm) geniş format 3 renk (Siyah-Beyaz-Kırmızı) destekli etiket.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d013891036e.png", price: 62.90, rentPrice: 4.50, minRentMonths: 12, specs: ["7.5 inç (19.1 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 7.5, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
    { id: "esl_sg_116b", series: "Supergalaxy Series", name: "LOKMA Smart Tag STag116B", category: "ESL Etiketleri", description: "11.6 inç (29.5 cm) devasa 3 renk (Siyah-Beyaz-Kırmızı) destekli ekran.", image: "https://www.minewtag.com/upload/goodsgallery/2024-08/66d142477638a.png", price: 85.90, rentPrice: 5.50, minRentMonths: 12, specs: ["11.6 inç (29.5 cm)", "3 Renkli (Siyah-Beyaz-Kırmızı)"], filters: { size: 11.6, tech: ["Bluetooth"], colors: 3, cold: false, water: false } },
