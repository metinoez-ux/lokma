...
const [reservations, setReservations] = useState<Reservation[]>([]);
 ...
 className="px-3 py-1.5 bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 rounded-lg hover:bg-gray-600 text-sm transition"
 >
 Aktualisieren
 </button>
 </div>
 ...
 <span className="text-xs text-muted-foreground/80 bg-gray-700 px-2 py-0.5 rounded">{t('gecmis')}</span>
 )}
 </div>

 <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
 <div>
 <p className="text-muted-foreground/80 text-xs">{t('musteri')}</p>
 ...
 <div>
 <p className="text-muted-foreground/80 text-xs">{t('tarih')}</p>
 <p className="text-foreground font-medium">{formatDate(res.reservationDate)}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs">{t('saat')}</p>
 <p className="text-foreground font-medium text-lg">{formatTime(res.reservationDate)}</p>
 </div>
 <div>
 <p className="text-muted-foreground/80 text-xs">{t('kisi')}</p>
 ...
 <span className="text-muted-foreground/80 text-xs">Masa No:</span>
 ...
 : "bg-muted/50 border border-border text-foreground/90 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 hover:bg-gray-600 hover:border-gray-500"
 }`}
 >
 {num}
 </button>
 ...
 className="flex-1 py-3 bg-muted/50 hover:bg-gray-300 text-foreground/90 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 rounded-lg font-medium transition"
 >
 İptal
 </button>
 <button
 ...
 ? "bg-gray-600 text-muted-foreground/80 cursor-not-allowed"
