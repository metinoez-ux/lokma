...
export default function BusinessesPage() {
 ...
 {rb.city && (
 <div className="text-muted-foreground/80 text-xs truncate">{rb.city}</div>
 )}
 </div>
 ...
 className="px-3 py-1 bg-muted/50 text-foreground/90 dark:bg-gray-700 dark:text-gray-100 rounded-lg hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ←
 </button>
 ...
 : 'border-gray-600 bg-muted/50 text-foreground/90 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600'
 }`}
 >
 <span>{type.icon}</span>
 ...
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('hesap_sahibi')}</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('banka', { defaultValue: 'Banka' })}</label>
 <input
 type="text"
 ...
 <div className="col-span-2">
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('iban')}</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('bic_swift')}</label>
 <input
 type="text"
 ...
 <div className="grid grid-cols-2 gap-3">
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('plan', { defaultValue: 'Plan' })}</label>
 <select
 ...
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('durum')}</label>
 <select
 ...
 <div>
 <label className="block text-muted-foreground/80 text-xs mb-1">{t('komisyonOrani')}</label>
 <input
 type="number"
 step="0.1"
 ...
 <p className="text-muted-foreground/80 text-xs">{t('toplamSiparis')}</p>
 </div>
 <div className="text-center">
 <p className="text-2xl font-bold text-blue-800 dark:text-blue-400">{editingBusiness.orderStats?.dailyAverage?.toFixed(1) || '0.0'}</p>
 <p className="text-muted-foreground/80 text-xs">{t('gunlukOrtalama')}</p>
 </div>
 <div className="text-center">
 ...
 <p className="text-muted-foreground/80 text-xs">{t('toplam_ciro')}</p>
 </div>
 <div className="text-center">
 <p className="text-sm text-foreground">
 {editingBusiness.orderStats?.lastOrderDate?.toDate?.()?.toLocaleDateString('de-DE') || '-'}
 </p>
 <p className="text-muted-foreground/80 text-xs">{t('sonSiparis')}</p>
 </div>
 </div>
 </div>
 )}
 ...
 <p className="text-muted-foreground/80 text-xs">{t('sonOdeme')}</p>
 </div>
 <div className="text-center">
 ...
 <p className="text-muted-foreground/80 text-xs">{t('son_tutar')}</p>
 </div>
 <div className="text-center">
 ...
 <p className="text-muted-foreground/80 text-xs">{t('acikBakiye')}</p>
 </div>
 <div className="text-center">
 <p className="text-xl font-bold text-foreground">{editingBusiness.billing?.invoiceCount || 0}</p>
 <p className="text-muted-foreground/80 text-xs">{t('faturaSayisi')}</p>
 </div>
 </div>
 ...
 <p className="text-muted-foreground/80 text-xs mt-1">{review.relative_time_description}</p>
 )}
 </div>
 ))}
 </div>
 ...
 <div className="p-4 text-center text-muted-foreground/80 text-sm">
