...
<body>
 ...
 <p className="text-xs text-muted-foreground/80 uppercase tracking-wider font-bold">{t('toplam_vardiya')}</p>
 <p className="text-3xl font-black text-foreground mt-1">{filteredShifts.length}</p>
 </div>
 <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-border rounded-2xl p-5">
 <p className="text-xs text-muted-foreground/80 uppercase tracking-wider font-bold">{t('personel_sayisi')}</p>
 <p className="text-3xl font-black text-cyan-800 dark:text-cyan-400 mt-1">{filteredStaffSummary.length}</p>
 </div>
 <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-border rounded-2xl p-5">
 <p className="text-xs text-muted-foreground/80 uppercase tracking-wider font-bold">{t('toplam_calisma')}</p>
 ...
 <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-border rounded-2xl p-5">
 <p className="text-xs text-muted-foreground/80 uppercase tracking-wider font-bold">{t('toplam_mola')}</p>
 ...
 <p className="text-muted-foreground/80 text-sm mt-1">{t('farkli_bir_ay_secmeyi_deneyin')}</p>
 </div>
 ) : (
