...
export default function VolunteersPage() {
 ...
 className="px-4 py-2 bg-muted/50 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-lg text-sm transition-colors"
 >
 ← Geri
 </Link>
 </div>
 ...
 // Rol badge rengi
 let roleColor = 'bg-muted text-foreground/90 dark:bg-gray-800 dark:text-gray-300';
