...
export default function VendorPricingPage() {
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
 {t('heroSub')}
 </p>
 </div>
 </section>
 ...
 <div className="inline-flex items-center bg-muted dark:bg-background/5 border border-border/50 rounded-2xl p-1.5 gap-1">
 {SEGMENTS.map(seg => (
 <button
 key={seg.id}
 ...
 : 'text-muted-foreground/80 dark:text-gray-400 hover:text-foreground dark:hover:text-white hover:bg-background/50 dark:hover:bg-background/5'
 }`}
 >
 ...
 : 'border-border/50 hover:border-border dark:hover:border-white/20'
 } bg-background dark:bg-background/[0.02]`}
 >
 {/* Popular badge */}
 {plan.highlighted && (
 ...
 {plan.description && (
 <p className="text-sm text-muted-foreground/80 dark:text-gray-400 mb-5 leading-relaxed">{plan.description}</p>
 )}
 ...
 {/* Limits compact grid */}
 <div className="grid grid-cols-3 gap-0 bg-muted/30 dark:bg-background/5 rounded-xl border border-border/30 p-1 mb-5">
 ...
 <div className="text-center py-2.5 border-x border-border/30 ">
 ...
 <span className="w-5 h-5 bg-muted dark:bg-background/5 text-gray-300 dark:text-muted-foreground rounded-full flex items-center justify-center flex-shrink-0">
 <span className="material-symbols-outlined text-[12px]">close</span>
 </span>
 )}
 <span className={val ? '' : 'text-gray-400 dark:text-muted-foreground/80 line-through'}>
 {t(labelKey)}
 </span>
 </div>
 );
 ...
 : 'bg-muted dark:bg-background/5 hover:bg-muted/50 dark:hover:bg-background/10 border border-border/50 '
 }`}
 >
 ...
 <tr key={key} className={idx % 2 === 0 ? 'bg-muted/30/50 dark:bg-background/[0.015]' : ''}>
 <td className="py-3 px-4 text-sm text-muted-foreground dark:text-gray-300">{t(labelKey)}</td>
 {plans.map(p => {
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-muted dark:bg-background/5">
 <span className="material-symbols-outlined text-gray-300 dark:text-muted-foreground text-[14px]">close</span>
 </span>
 )}
 </td>
 );
 ...
 <tr className="bg-muted/30/50 dark:bg-background/[0.015]">
 <td className="py-3 px-4 text-sm text-muted-foreground dark:text-gray-300">{t('orders')}</td>
 {plans.map(p => (
 ...
 <tr>
 <td className="py-3 px-4 text-sm text-muted-foreground dark:text-gray-300">{t('products')}</td>
 {plans.map(p => (
 <td key={p.id} className="text-center py-3 px-3 text-sm font-bold">
 ...
 <tr className="bg-muted/30/50 dark:bg-background/[0.015]">
 <td className="py-3 px-4 text-sm text-muted-foreground dark:text-gray-300">{t('staff')}</td>
 {plans.map(p => (
 <td key={p.id} className="text-center py-3 px-3 text-sm font-bold">
 ...
 <tr>
 <td className="py-3 px-4 text-sm text-muted-foreground dark:text-gray-300">{t('commission')} (Gel-Al)</td>
 {plans.map(p => (
 <td key={p.id} className="text-center py-3 px-3 text-sm font-bold">
 ...
 {/* ── FAQ ──────────────────────────────────────────── */}
 <section className="pb-20 px-4 md:px-8 bg-muted/30 dark:bg-[#0f172a] py-20">
 <div className="max-w-3xl mx-auto">
 <h2 className="text-3xl font-black tracking-tight text-center mb-10">{t('faqTitle')}</h2>
 <div className="space-y-3">
 {faqs.map((faq, index) => (
 <div key={index} className="border border-border/50 rounded-2xl overflow-hidden bg-background dark:bg-background/[0.02]">
 <button
 ...
 <div className="px-5 pb-5 text-muted-foreground/80 dark:text-gray-400 text-sm leading-relaxed">
 {faq.a}
 </div>
 </div>
 </div>
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 text-lg mb-8 max-w-2xl mx-auto">{t('ctaSub')}</p>
