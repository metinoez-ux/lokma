...
export default function VendorPage() {
 ...
 <p className="text-lg md:text-xl text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 max-w-3xl mx-auto mb-12 leading-relaxed">
 {tx('heroSub')}
 </p>
 ...
 <Link href="#features" className="inline-flex items-center justify-center gap-2 bg-muted dark:bg-background/10 dark:bg-background/10 hover:bg-muted/50 dark:hover:bg-background/20 dark:hover:bg-background/20 border border-border/50 text-foreground px-10 py-4 rounded-2xl font-bold text-lg transition-all">
 {tx('ctaLearnMore')}
 <span className="material-symbols-outlined text-[18px]">expand_more</span>
 </Link>
 <Link href="/vendor/pricing" className="inline-flex items-center justify-center gap-2 bg-background hover:bg-muted/30 dark:hover:bg-background/5 dark:bg-[#152033] dark:hover:bg-background/5 dark:bg-[#0f172a] border-2 border-[#ea184a]/30 text-[#ea184a] px-10 py-4 rounded-2xl font-bold text-lg transition-all hover:border-[#ea184a]">
 <span className="material-symbols-outlined text-[18px]">payments</span>
 {tx('pricingLink')}
 </Link>
 </div>
 <p className="text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-sm font-medium mb-4">{tx('ctaSub')}</p>
 <Link href="/login" className="inline-flex items-center gap-2 text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 hover:text-[#ea184a] text-sm font-medium transition-colors">
 ...
 {/* Stats Bar */}
 <section className="relative z-10 py-8 border-y border-border/30 bg-muted/30 dark:bg-[#152033] dark:bg-[#0f172a]">
 <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
 {stats.map((s, i) => (
 <div key={i} className="text-center">
 <div className="text-3xl md:text-4xl font-black text-[#ea184a]">{s.value}</div>
 <div className="text-sm text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 font-medium mt-1">{s.label}</div>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-lg">{tx('whySub')}</p>
 </div>
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
 {advantages.map((a, i) => (
 <div key={i} className="group bg-muted/30 dark:bg-[#152033] dark:bg-[#0f172a] border border-border/50 hover:border-[#ea184a]/30 p-8 rounded-2xl transition-all duration-300 hover:-translate-y-1">
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 leading-relaxed">{a.desc}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-lg mb-8 leading-relaxed">{tx('posSub')}</p>
 <ul className="space-y-4 mb-10">
 {[tx('posF1'), tx('posF2'), tx('posF3'), tx('posF4')].map((f, i) => (
 <li key={i} className="flex items-center gap-3 text-foreground/80 dark:text-gray-300 dark:text-gray-300">
 ...
 <div className="relative bg-muted/30 dark:bg-[#152033] dark:bg-[#0f172a] border border-border/50 rounded-3xl p-8 overflow-hidden">
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-lg mb-8 leading-relaxed">{tx('eslSub')}</p>
 <ul className="space-y-4 mb-10">
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-lg mb-8 leading-relaxed">{tx('deliverySub')}</p>
 <ul className="space-y-4 mb-10">
 ...
 <div className="relative bg-muted/30 dark:bg-[#152033] dark:bg-[#0f172a] border border-border/50 rounded-3xl p-8">
 <div className="grid grid-cols-2 gap-4">
 <div className="bg-background dark:bg-background/5 rounded-2xl p-6 border border-border/50 text-center">
 <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">gps_fixed</span>
 <p className="text-sm text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80">{tx('deliveryF1')}</p>
 </div>
 <div className="bg-background dark:bg-background/5 rounded-2xl p-6 border border-border/50 text-center">
 <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">route</span>
 <p className="text-sm text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80">{tx('deliveryF2')}</p>
 </div>
 <div className="bg-background dark:bg-background/5 rounded-2xl p-6 border border-border/50 text-center">
 <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">schedule</span>
 <p className="text-sm text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80">{tx('deliveryF3')}</p>
 </div>
 <div className="bg-background dark:bg-background/5 rounded-2xl p-6 border border-border/50 text-center">
 <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">photo_camera</span>
 <p className="text-sm text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80">{tx('deliveryF4')}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80">{step.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <p className="text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 dark:text-muted-foreground/80 dark:text-gray-400 dark:text-muted-foreground/80 text-lg mb-10 max-w-2xl mx-auto">{tx('bottomCtaSub')}</p>
