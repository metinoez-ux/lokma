        ...
        <div className="relative flex min-h-screen flex-col bg-[#0a0a0f] text-white font-['Plus_Jakarta_Sans',sans-serif] overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#fb335b]/10 rounded-full blur-[120px]" />
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8">
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                            ...
                            <Link href="#features" className="inline-flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all">
                                {tx.ctaLearnMore}
            ...
            <section id="features" className="py-24 px-4 md:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-white/50 text-lg">{tx.whySub}</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {advantages.map((a, i) => (
                            <div key={i} className="group bg-white/[0.03] border border-white/5 hover:border-[#fb335b]/30 p-8 rounded-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            {/* POS System */}
            <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-transparent via-white/[0.02] to-transparent">
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-white/60 text-lg mb-8 leading-relaxed">{tx.posSub}</p>
                            <ul className="space-y-4 mb-10">
                                {[tx.posF1, tx.posF2, tx.posF3, tx.posF4].map((f, i) => (
                                    <li key={i} className="flex items-center gap-3 text-white/80">
                                        <span className="w-6 h-6 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-[#fb335b]/10 to-purple-500/10 rounded-3xl blur-xl" />
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            <span className="inline-flex items-center gap-2 text-blue-400 text-sm font-bold uppercase tracking-widest mb-6">
                            ...
                            <p className="text-white/60 text-lg mb-8 leading-relaxed">{tx.eslSub}</p>
                            <ul className="space-y-4 mb-10">
                                {[tx.eslF1, tx.eslF2, tx.eslF3, tx.eslF4].map((f, i) => (
                                    <li key={i} className="flex items-center gap-3 text-white/80">
                                        <span className="w-6 h-6 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center flex-shrink-0">
                                            <span className="material-symbols-outlined text-[14px]">check</span>
                                        </span>
                                        {f}
                                    </li>
                            ...
                            <Link href="/hardware" className="inline-flex items-center gap-2 text-blue-400 font-bold hover:underline">
            ...
            <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-transparent via-white/[0.02] to-transparent">
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <span className="inline-flex items-center gap-2 text-emerald-400 text-sm font-bold uppercase tracking-widest mb-6">
                                <span className="material-symbols-outlined text-[18px]">local_shipping</span>
                                Delivery
                            </span>
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6">{tx.deliveryTitle}</h2>
                            <p className="text-white/60 text-lg mb-8 leading-relaxed">{tx.deliverySub}</p>
                            <ul className="space-y-4 mb-10">
                            ...
                            <Link href="/kurye" className="inline-flex items-center gap-2 text-emerald-400 font-bold hover:underline">
                            ...
                            <div className="relative bg-white/5 border border-white/10 rounded-3xl p-8">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-400 mb-3 block">gps_fixed</span>
                                        <p className="text-sm text-white/60">{tx.deliveryF1}</p>
                                    </div>
                                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-400 mb-3 block">route</span>
                                        <p className="text-sm text-white/60">{tx.deliveryF2}</p>
                                    </div>
                                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-400 mb-3 block">schedule</span>
                                        <p className="text-sm text-white/60">{tx.deliveryF3}</p>
                                    </div>
                                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-400 mb-3 block">photo_camera</span>
                                        <p className="text-sm text-white/60">{tx.deliveryF4}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-24 px-4 md:px-8">
                <div className="max-w-4xl mx-auto relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#fb335b]/20 to-purple-500/20 rounded-3xl blur-xl" />
                    <div className="relative bg-gradient-to-br from-[#fb335b]/10 to-purple-500/10 border border-white/10 rounded-3xl p-12 md:p-16 text-center">
                        <h2 className="text-4xl md:text-5xl font-black mb-6">{tx.bottomCta}</h2>
                        <p className="text-white/60 text-lg mb-10 max-w-2xl mx-auto">{tx.bottomCtaSub}</p>
