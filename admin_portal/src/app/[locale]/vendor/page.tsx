    ...
    <div className="relative flex min-h-screen flex-col bg-white text-gray-900 font-['Plus_Jakarta_Sans',sans-serif] overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 leading-tight">{txt.desktopTitle1} <br/>{txt.desktopTitle2}</h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-lg">{txt.desktopF1Title}</h4>
                    <p className="text-gray-500 text-sm">{txt.desktopF1Desc}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                  <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-lg">{txt.desktopF2Title}</h4>
                    <p className="text-gray-500 text-sm">{txt.desktopF2Desc}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 leading-tight">{txt.kioskTitle1} <br/>{txt.kioskTitle2}</h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                {txt.kioskSub}
              </p>
              
              <div className="flex flex-wrap gap-3">
                <span className="px-6 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-bold text-sm">{txt.kioskF1}</span>
                <span className="px-6 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-bold text-sm">{txt.kioskF2}</span>
                <span className="px-6 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-bold text-sm">{txt.kioskF3}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6">{txt.mobileTitle}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-lg flex flex-col items-center text-center group hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">{txt.mobileCard1Title}</h3>
              <p className="text-gray-600 text-lg">{txt.mobileCard1Desc}</p>
            </div>
            ...
            <div className="bg-white rounded-[2rem] overflow-hidden border border-gray-100 shadow-lg relative group hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-10 flex-1 flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-black text-gray-900 mb-4">{txt.mobileCard2Title}</h3>
                <p className="text-gray-600 text-lg">{txt.mobileCard2Desc}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6 mt-12">
                  <div className="bg-gray-50 border border-gray-100 rounded-3xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-xl font-black text-gray-900 mb-1">{txt.eslLabel1}</div>
                    <div className="text-gray-500 text-sm font-medium">{txt.eslLabel1Sub}</div>
                  </div>
                  <div className="bg-gray-50 border border-gray-100 rounded-3xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-xl font-black text-gray-900 mb-1">{txt.eslLabel2}</div>
                    <div className="text-gray-500 text-sm font-medium">{txt.eslLabel2Sub}</div>
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="bg-gray-50 border border-gray-100 rounded-3xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-xl font-black text-gray-900 mb-1">{txt.eslLabel3}</div>
                    <div className="text-gray-500 text-sm font-medium">{txt.eslLabel3Sub}</div>
                  </div>
                  <div className="bg-gray-50 border border-gray-100 rounded-3xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-xl font-black text-gray-900 mb-1">{txt.eslLabel4}</div>
                    <div className="text-gray-500 text-sm font-medium">{txt.eslLabel4Sub}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-32 px-6 bg-gray-50 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-black mb-8 text-gray-900 leading-tight">{txt.bottomTitle}</h2>
