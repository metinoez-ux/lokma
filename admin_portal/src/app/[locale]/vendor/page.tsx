...
export default function VendorPage() {
    ...
    return (
        <div className="relative flex min-h-screen flex-col bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white font-['Plus_Jakarta_Sans',sans-serif] overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 dark:text-gray-500 max-w-3xl mx-auto mb-12 leading-relaxed">
                            {tx('heroSub')}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                            ...
                            <Link href="#features" className="inline-flex items-center justify-center gap-2 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 border border-gray-200 dark:border-white/10 text-gray-900 px-10 py-4 rounded-2xl font-bold text-lg transition-all">
                                {tx('ctaLearnMore')}
                                <span className="material-symbols-outlined text-[18px]">expand_more</span>
                            </Link>
                            <Link href="/vendor/pricing" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 dark:hover:bg-white/5 dark:bg-[#0f172a] border-2 border-[#ea184a]/30 text-[#ea184a] px-10 py-4 rounded-2xl font-bold text-lg transition-all hover:border-[#ea184a]">
                                <span className="material-symbols-outlined text-[18px]">payments</span>
                                {tx('pricingLink')}
                            </Link>
                        </div>
                        <p className="text-gray-400 dark:text-gray-500 text-sm font-medium mb-4">{tx('ctaSub')}</p>
                        <Link href="/login" className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-[#ea184a] text-sm font-medium transition-colors">
            ...
            {/* Stats Bar */}
            <section className="relative z-10 py-8 border-y border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#0f172a]">
                <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {stats.map((s, i) => (
                        <div key={i} className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#ea184a]">{s.value}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 font-medium mt-1">{s.label}</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section id="features" className="py-24 px-4 md:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg">{tx('whySub')}</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {advantages.map((a, i) => (
                            <div key={i} className="group bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-white/10 hover:border-[#ea184a]/30 p-8 rounded-2xl transition-all duration-300 hover:-translate-y-1">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 leading-relaxed">{a.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg mb-8 leading-relaxed">{tx('posSub')}</p>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-white/10 rounded-3xl p-8 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg mb-8 leading-relaxed">{tx('eslSub')}</p>
                            <ul className="space-y-4 mb-10">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg mb-8 leading-relaxed">{tx('deliverySub')}</p>
                            <ul className="space-y-4 mb-10">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-white/10 rounded-3xl p-8">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 text-center">
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{tx('deliveryF1')}</p>
                                    </div>
                                    <div className="bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">route</span>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{tx('deliveryF2')}</p>
                                    </div>
                                    <div className="bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">schedule</span>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{tx('deliveryF3')}</p>
                                    </div>
                                    <div className="bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 text-center">
                                        <span className="material-symbols-outlined text-4xl text-emerald-600 mb-3 block">photo_camera</span>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{tx('deliveryF4')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {steps.map((step, i) => (
                            <div key={i} className="relative group text-center">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">{step.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-24 px-4 md:px-8">
                <div className="max-w-4xl mx-auto relative">
                    ...
                    <div className="relative bg-gradient-to-br from-[#ea184a]/5 to-purple-500/5 border border-gray-200 dark:border-white/10 rounded-3xl p-12 md:p-16 text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg mb-10 max-w-2xl mx-auto">{tx('bottomCtaSub')}</p>
