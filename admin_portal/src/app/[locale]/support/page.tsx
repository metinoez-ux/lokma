...
export default function SupportPage() {
 ...
 <p className="text-muted-foreground/80 /60 text-lg mb-12">{tx.subtitle}</p>
 ...
 <div key={idx} className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-xl overflow-hidden">
 <button
 ...
 <div className="px-5 pb-5 text-muted-foreground /60">
 {faq.a}
 </div>
 )}
 </div>
