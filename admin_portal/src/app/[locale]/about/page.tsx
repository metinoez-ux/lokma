...
export default function AboutPage() {
 ...
 <div className="space-y-8 text-muted-foreground /80 text-lg leading-relaxed">
 <p>
 <strong className="text-foreground ">LOKMA</strong> — {t('intro')}
 </p>
 ...
 <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">{t('valuesTitle')}</h2>
