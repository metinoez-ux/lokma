...
export default function PressPage() {
 ...
 <div className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-2xl p-8 mb-12">
 <h2 className="text-xl font-bold mb-4">{t('contactTitle')}</h2>
 <p className="text-muted-foreground/80 /60 mb-6">{t('contactDesc')}</p>
 ...
 <div key={k} className="bg-muted/30 dark:bg-background/5 border border-border/50 rounded-xl p-6">
 ...
 <p className="text-sm text-muted-foreground/80 /60 mb-4">{t(`${k}d`)}</p>
 ...
 <div className="text-muted-foreground /70 space-y-4">
 <p><strong className="text-foreground ">LOKMA</strong> — {t('a1')}</p>
 <p>{t('a2')}</p>
 <p>{t('a3')}</p>
 </div>
 </div>
