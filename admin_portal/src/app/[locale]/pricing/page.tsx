...
export default function SubscriptionPage() {
 ...
 <div key={key} className={`bg-background rounded-2xl shadow-xl overflow-hidden ${module.monthly === 0 ? 'ring-4 ring-green-400' : ''}`}>
 {module.monthly === 0 && (
 ...
 <span className="text-4xl font-bold text-foreground">{module.monthly}</span>
 <span className="text-muted-foreground/80 ml-1">{t('perMonth')}</span>
 </div>
