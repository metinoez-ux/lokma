...
export default function PartnerApplyPage() {
 ...
 if (submitted) {
 return (
 <div className="min-h-screen bg-background dark:bg-[#0f172a] text-foreground font-['Plus_Jakarta_Sans',sans-serif] flex items-center justify-center">
 <div className="text-center max-w-md mx-auto p-8">
 <div className="w-20 h-20 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
 <span className="material-symbols-outlined text-green-500 text-4xl">check_circle</span>
 </div>
 <h1 className="text-3xl font-bold mb-4">{t('successTitle')}</h1>
 <p className="text-muted-foreground/80 /60 mb-8">{t('successDesc')}</p>
 ...
 <p className="text-muted-foreground/80 /60 mb-8">{t('subtitle')}</p>

 <form onSubmit={handleSubmit} className="space-y-6">
 <div>
 <label className="block text-sm font-medium mb-2">{t('businessName')}</label>
 <input type="text" required className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all"
 ...
 <select required className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all"
 ...
 <input type="email" required className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all"
 placeholder="ornek@email.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
 </div>
 <div>
 <label className="block text-sm font-medium mb-2">{t('phone')}</label>
 <input type="tel" required className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all"
 ...
 <input type="text" className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all"
 ...
 <textarea rows={3} className="w-full bg-muted dark:bg-background/5 border border-border/50 rounded-xl px-4 py-3 focus:border-[#ea184a] focus:outline-none transition-all resize-none"
 ...
 <p className="text-center text-gray-400 /40 text-sm">
