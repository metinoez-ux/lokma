            ...
            <section className="py-24 px-4 md:px-20 lg:px-40 bg-gray-50 dark:bg-white/[0.02] border-y border-gray-200 dark:border-white/5 relative">
                <div className="max-w-[1200px] mx-auto text-center relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {benefits.map((b, i) => (
                            <div key={i} className="bg-white dark:bg-[#0a0a0f] p-8 rounded-[2rem] border border-gray-200 dark:border-white/10 hover:border-[#fb335b]/50 transition-colors text-center flex flex-col items-center group hover:-translate-y-2 duration-300 shadow-2xl shadow-black">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                            {steps.map((step, i) => (
                                <div key={i} className="text-center group">
                                    <div className="w-24 h-24 bg-white dark:bg-[#0a0a0f] border-4 border-gray-200 dark:border-white/10 group-hover:border-[#fb335b] transition-colors rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl shadow-black">
