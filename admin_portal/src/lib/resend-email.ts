        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #1a1a1a; color: white;">
                ...
                <div style="padding: 30px;">
                    <h2 style="color: #ea184a; margin: 0 0 15px 0; font-size: 22px;">Merhaba ${details.customerName}!</h2>
                    ...
                    <!-- Warning -->
                    <div style="background: #3d2020; border-radius: 8px; padding: 15px; margin-top: 20px; border-left: 3px solid #ea184a;">
    ...
    newOrderVendor: (details: {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #1a1a1a; color: white;">
                ...
                <!-- Content -->
                <div style="padding: 30px;">
                    <h2 style="color: #ea184a; margin: 0 0 15px 0; font-size: 22px;">Sipariş #${details.orderId.slice(0, 6).toUpperCase()}</h2>
                    ...
                    <!-- Order Details -->
                    <div style="background: #2a2a2a; border-radius: 12px; padding: 15px; border-left: 4px solid #ea184a;">
