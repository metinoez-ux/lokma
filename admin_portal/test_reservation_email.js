...
const resend = new Resend("re_Q895UvnJ_HQHxJWPMEZAZLJ25groCzdYT");
...
const businessAddress = "Mustafa Kemal Paşa Mh. İstiklal Cd. No:42, Beyoğlu, İstanbul";
...
<head>
    ...
    <style>
        ...
        .table-card { border-top: 1px solid #eaeaea; border-bottom: 1px solid #eaeaea; padding: 24px 0; margin: 24px 0; text-align: center; }
        ...
        .table-card-numbers-wrapper { text-align: center; }
        .table-card-numbers { display: inline-block; background-color: ${brandColor}; color: #ffffff; padding: 10px 20px; border-radius: 10px; font-size: 22px; font-weight: 800; margin: 0 8px; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .table-card { border-color: #222222 !important; }
        ...
        <div class="email-body">
            ...
            <div class="content">
                ...
                <div class="calendar-section" style="margin-top: 10px; border-top: none; padding-top: 0;">
                    <a href="${mapsUrl}" target="_blank" class="calendar-btn" style="background-color: ${brandColor}; color: #ffffff !important;">📍 Yol Tarifi Al</a>
