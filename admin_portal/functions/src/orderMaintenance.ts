...
import { getUserLanguage, getPushTranslations } from "./utils/translation";
 ...
 */
export const nightlyOrderArchive = onSchedule(
    {
 ...
 */
export const delayedOrderNotification = onSchedule(
    {
                ...
                for (const doc of snap.docs) {
                    ...
                    if (fcmToken) {
                        try {
                            ...
                            const translations = await getPushTranslations(lang);
