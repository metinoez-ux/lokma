...
exports.onKermesRosterDeleted = exports.onKermesRosterUpdated = exports.onKermesRosterCreated = void 0;
...
exports.onKermesRosterCreated = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        if (rawGender === 'female' || rawGender === 'kadin' || rawGender === 'kadın')
            bolumStr = "Hanımlar Bölümü";
        else if (rawGender === 'male' || rawGender === 'erkek')
            bolumStr = "Erkekler Bölümü";
...
exports.onKermesRosterUpdated = (0, firestore_2.onDocumentUpdated)("kermes_events/{kermesId}/rosters/{rosterId}", async (event) => {
 ...
 */
exports.onKermesRosterDeleted = (0, firestore_3.onDocumentDeleted)({
    document: "kermes_events/{kermesId}/rosters/{rosterId}",
    secrets: [resendApiKey]
}, async (event) => {
