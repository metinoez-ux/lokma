...
const strings = JSON.parse(fs.readFileSync('kermes_strings.json', 'utf8'));
const map = {};
...
fs.writeFileSync('kermes_map.json', JSON.stringify(map, null, 2));
fs.writeFileSync('kermes_tr.json', JSON.stringify(trJson, null, 2));
