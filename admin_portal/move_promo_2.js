...
// Extract Promo block (find beginning of the line for promoStartIndex, and beginning of the line for limitsStartIndex)
const startIdx = content.lastIndexOf('\n', promoStartIndex) + 1;
const endIdx = content.lastIndexOf('\n', limitsStartIndex) + 1;

let promoBlock = content.substring(startIdx, endIdx);
...
content = content.substring(0, insertIdx) + promoBlock + content.substring(insertIdx);
